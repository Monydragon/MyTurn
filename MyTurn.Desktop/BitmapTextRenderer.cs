...
internal sealed class BitmapTextRenderer
{
    ...
    public BitmapTextRenderer(SpriteBatch spriteBatch, Texture2D pixel)
    {
        _spriteBatch = spriteBatch;
        _pixel = pixel;
    }

    public void Draw(string text, Vector2 position, Color color, int scale)
    {
            ...
            for (var y = 0; y < glyph.Length; y++)
            {
                for (var x = 0; x < glyph[y].Length; x++)
                {
                    if (glyph[y][x] == '1')
                    {
                        _spriteBatch.Draw(
                            _pixel,
                            new Rectangle(cursorX + x * safeScale, cursorY + y * safeScale, safeScale, safeScale),
                            color);
                    }
                }
            }
